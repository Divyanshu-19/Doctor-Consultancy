...
export const transMailBookingNew = {
    subject: "Email notification of booking progress at Doctor Consultation",
    template: (data) => {
        return `<h3>Thank you for booking an appointment at Doctor Consultation system </h3>
        ...
        <h4>Doctor Consultation system will automatically send email notification when confirmed appointment is complete. Thank you !</h4>`;
    },
};
...
export const transMailBookingFailed = {
    subject: "Email notification of booking progress at Doctor Consultation",
    template: (data) => {
        return `<h3>Thank you for booking an appointment at Doctor Consultation's system  </h3>
        <h4>Information for booked appointment:</h4>
        <div>Doctor's name: ${data.doctor} </div>
        <div>Time: ${data.time}</div>
        <div>Date: ${data.date}</div>
...
export const transMailRemedy= {
    ...
    template: (data) => {
        return `<h3>Thank you for your trust in booking a medical examination in Doctor Consultancy.</h3>
        ...
        <br>
        <div>For example: Full name: Tony Stark, with the registered phone number: 0123456789 and born: 1910, the extracted password is: <b> tonystark-012-10 </b> </div>
        <br>
        <div><b><a href="https://meet.google.com/bbz-buyk-eee">Join Meet</a></b></div>
